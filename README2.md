...
>
Инструкция как добавить мета теги в посты и страницы https://www.dev-eth0.de/blog/2016/11/16/jekyll_social_sharing.html но в уставноленной теме уже ест ьфал для Мета (возможно он устрел), вообщем мета не отображается при прстинге, нужно разобраться как правильно. В коде на странице мета теги есть, при прстинге в фесбук нужно подумат ькак отображат ькартинку или с поста или общую (если в посте нет картинки).
