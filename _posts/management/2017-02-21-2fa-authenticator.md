...
Ниже в статье будут рассматриваться все детали двухфакторной аутентификации с помощью приложения Google Authenticator и его аналогов. SMS и другие виды аутентификации на странице рассматриваться не будут.


Two-factor authentication (2FA), 2-Step verification - двухфакторная аутентификация, двоэтапная проверка.
...
(если отключен Google Authenticatorвключите хотя бы вход с sms защитой).  
