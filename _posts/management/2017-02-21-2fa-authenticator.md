...
<ul class="accordion">
	<li class="accordion-li">
		...
		<ol>
			...
			<li>Заходите на ваш сайт где вы собрались подключать, переходите на страницу для подключения.</li>
			...
			<li>Подносите смартфон к экрану компьютера там где открыт ваш сайт со штрих кодом, все штрих код добавлен. В программе Google Authenticator начинают генерироватся 30 секундные коды, вам нужно вписать этот код на странице сайта в окошко под штрих кодом и нажать подтвердить.</li>
