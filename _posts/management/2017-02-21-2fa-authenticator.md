...
<ul class="accordion">
	...
	<li class="accordion-li">
		...
		<h3>Как пользоватсья на ПК:</h3>
		<p>
Если вы хотите использовать только на ПК, тогда
		</p><p>
1. На смартфон ничего устанавливать не нужно.
		</p><p>
2. Устанавливаете приложение для браузера https://www.authy.com/app/desktop/
		</p><p>
3. После установки предложит установит ьеще одно предложение для браузера, да оин нужны оба, устанавливаете.
		</p><p>
4. В браузере появится значок сверху, нажимаете его, выбираете своей код страны и вписываете номер своего моб телефона.
		</p><p>
5. На номер придет смс, код из смс нужно ввести на ПК в приложении, чтоб его активирвоать.
		</p><p>
6. Ввели код, вас пустило внутрь приложения.
		</p><p>
7. Вам нужно задать код для доступа к программе, вписываете, главное не забудьте его. Но после переустановки программы этого кода не будет, и вам придется заново назначать новый код.
		</p><p>
...
9. После того как вы назначили пароль для доступа в программу, и пароль для бекапа, желательно в настроках добавть свой емейл, и подтвердить его.
		</p><p>
10. Все, теперь вы можете добавлять нужные вам сайты, чтоб добавить сайт нужно нажать на шестеренку, откроется окно с настройками, перейдите на вкладку "External Accaunts" снизу будет надпись "Add Authenticator Account", нажимаете и вписываете там код от вашег осайта (код который возле штрх-кода, штрих-код и код возле него идентичны, в программе нужно вписать просто код. На следуйщем шаге выбираете иконку, любую, пункт Token lenght: 6-digh, и в окошке нижн вписывает любое имя, но желательно чтоб имя было такое как ваш сайт, чтоб вы знали этот код для какого сайта. После чего надимаете кнопку "Done" и потом закріваете окно с настроками (нажимаете на крестик). Окно закрілось и автоматом открілось маленькое окно с вашим добавленнім кодом, все можете нажать на свой добавленній сайт и там увидите 30 секундніе коді доступа.
		</p>
		</div>
	</li>
