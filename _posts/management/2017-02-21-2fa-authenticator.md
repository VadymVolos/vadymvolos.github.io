...
Ниже в статье буду рассматривать все детали двухфакторной аутентификации с помощью приложения Google Authenticator и его аналогов. SMS и другие виды аутентификации на странице рассматриваться не будут.
