...
SEO специалисты анализируют всю статистику, ищут неоптимизированный текст или неоптимизированные блоки на сайте, и потом ставят задачу копирайтерам, и если нужно решить технические детали, ставят задачу програмистам. Коприйтеры как правило должны разбиратся в SEO, но не факт, если он шарит в SEO зачем ему быть копирайтером, он может возглавить более высокие должности, чем просто писать красивый текст. SEO связано с большим обьемом аналитики, если копирайтер будет заниматся аналитикой у него будет мало времени для написания красивого текста.
	...
	<li class="accordion-li">
		...
		<div class="accordion-content">
		<p>
		На западе копирайтинг назвывается более продвинутым термином "Контент маркетинг" (Контент маркетолог). Задача контент маркетинга создавать контент для сайта, соц сетей, ютуб канала, инстаграма, и тд, отталкиваясь о тех целей которые нужно достичь. Контент маркетинг это инструмент для достижения целей, ставим цели, и от цели уже принимаем решение какой тип контента нам подходит, и заранее предусматриваем как мы будем этот контент распространять. 
		</p>
		<p>
		...
		<p>	
		Чтоб давать правильный контент, нужно изучать свою аудиторию, общатся с аудиторией, тем самым будет понимание в их потребносятх, их целях, проблемах, тем самым можно будет более удачно создать кнотент которые нужен и важен вашей аудитории. Временным копирайтером тут не отделатся, нужна команда из людей которые будут создават ьправильный контент, изучат ьваш продукт, записыват ьвидео про ваш продукт, и тд.
		</p>
		</div>
	</li>
