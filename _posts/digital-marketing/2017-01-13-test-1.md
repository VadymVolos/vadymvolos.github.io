...
<!-- /Modal button -->
<div class="remodal" data-remodal-id="modal-1" data-remodal-options="hashTracking: false" style="height:98%;">
  <button data-remodal-action="close" class="remodal-close"></button>
  <iframe src="https://vadymvolos.github.io/test-1/" style="">Текст в фрейме</iframe>
</div>
<!-- /Modal -->
