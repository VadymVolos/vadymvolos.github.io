...
<ul class="accordion">
	...
	<li class="accordion-li">
      ...
      <li><a rel="nofollow" target="_blank" class="hvr-wobble-vertical" href="https://serpstat.com/?ref=11598" onclick="ga('send', 'event', 'outbound', 'click', 'http://keyassort.ru/');">keyassort (программа под Windows для групировки запросов, в бесплатной версии нет экспорта, но в MegaIndex есть)</a></li>
      </ul>
<p>
...
MegaIndex и Serpstat платные, но в них есть бесплатные тарифы, c помощью которых тоже можно очень много собрать статистики. В первую очередь применяйте Wordstat Yandex и Google AdWords Keyword Planner, а потом уже будете другие сервисы изучать.
	...
	<li class="accordion-li">
		<a class="accordion-a"><h3>Самая большая растрата денег у новичков</h3></a>
		<div class="accordion-content">
		<p>		
		Новички часто на своем сайте/ютубе/соцсетях постят контент на разные темы. В следствии сайт не развивается, много контента, но посетителей мало. Много потрачено сил и времени, и недополученно прибыли, а толку ноль.
		</p><p>
		Главная задача на сайте - собрать концентрированный материал по узкой теме, сделать проект узкозаточенным, и тогда он начнет расти и набирать интерес.
		</p><p>
		Только нужно помнить что узкозаточенный должен иметь аудиторию, проверьте в вордстате, сколько трафика сможете получать в месяц, по запросам из выбранной вами узкой направленности.
		</p><p>
		PS Если вы наемный сотрудник, и придет необходимость сменить работу, то контент в ваших соц сетях узкой направленности быстро поможет новым работодателям оценить вашу экспертность, и понять подходите вы им или нет. Как правило если в соц сетях у вас все ок, то когда вы напишите пост что вы уволились, вам поступит много заявок взять вас к себе на работу. Или сделать бизнес вместе.
		</p><p>
		Вот это называется тонкости маркетинга.
		</p><p>
		У барышень которые правильно умеют позиционировать себя всегда есть мужчина. А те кто не умеют сидят без мужчины.
		</p>		
		</div>
	</li>
	
	<li class="accordion-li">
		<a class="accordion-a"><h3>Супер важная деталь при создании контента</h3></a>
		<div class="accordion-content">
		<p>
		Очень важно, начинать записывать видео, или писать текст для статьи, с хорошим позитивным радостным настроением. Если у вас настроение опустошенное, уставшее, это будет предаваться вашим зрителям, слушателям, и даже если у вас текстовая статья, с помощью текста это тоже будет передаваться читателям вашего текста.
		</p><p>
		Поэтому! Очень важно при создании контента чтоб вы были полны сил, полны энергии, с отличным настроением. И тогда ваша аудитория будет к вам липнтуь как к магниту. 
		</p><p>
		P.S. Если вы сделали пару дублей и это вас выматало, ваше состоянние стало уставшим, лучше отложить на пару часиков создание контента, пойти отдохнуть, занятся делами которые вам дадут энергию, а потом бодрячком придете и быстренько сделайте свой контент.
		</p>
		</div>
	</li>
