...
<ul class="accordion">
	...
	<li class="accordion-li">
		...
		<p>
            ...
            <br><br>
		    1. Хостинги бдят порядок и могут ваш сайт заблокировать ссылаясь что в правилах четко прописано что это делать нельзя и они будут правы.
            <br><br>
            ...
            <br><br>
		    4. Если тема ворованная вы не сможете получать обновления. Как правило раз в месяц обновляется движок WordPress, и авторам тем нужно проверять свои темы на совместимость и в случае ошибок вовремя доработать, чтоб клиенты вместе с обновлением для движка получили обновления для темы. Покупатели темы имеют возможность получать обновления для темы. И и также обязательно ест ьподдержка от автора, можно с ним консульироваться, задавать вопросы.
            <br><br>
